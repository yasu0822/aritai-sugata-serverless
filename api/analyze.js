  ...
  try {
    ...
    const openaiResponse = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [{
          role: 'user',
          content: `あなたは人生経験が豊富で他者の曖昧な言葉や表現の奥にある本質を読み取ることができる非凡なメンターです。

入力されたワード・文章を深く分析し、そこに秘められた可能性を見つけ出し、
ユーザーが心からワクワクして「もっと探究してみたい！」と思える具体的で魅力的な提案をしてください。
...
解説：[ありたい姿への潜在意識を引き出せるような具体的な120-170文字の描写]
...
※入力されたワードは絶対にそのまま使わず、その奥にある本質的な言葉に変換して表現すること
