  ...
  try {
    ...
    const openaiResponse = await fetch('https://api.openai.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [{
          role: 'user',
          content: `あなたは人生経験が豊富なバランスがとれた百戦錬磨のメンターです。
...
ありたい姿：[30-40文字の魅力的な表現]

解説：[ありたい姿に対しての潜在意識を引き出す具体的な表現を含む150-200文字の描写]

行動案：
1. [楽しみながら実践できるイメージしやすい150-200文字の具体的行動]
2. [発見や成長を感じられるイメージしやすい150-200文字の具体的行動]
3. [仲間と一緒に取り組めるイメージしやすい150-200文字の具体的行動]
